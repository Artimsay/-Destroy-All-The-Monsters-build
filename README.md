...
The monsters are defenseless in close combat, so instead of directly protecting themselves, they build increasingly dangerous environments filled with traps designed to stop the player.
...
Movement is intentionally physics-based and includes an element of unpredictability: the character may stumble before jumping, reducing the distance of the jump. This can cause unexpected situations, such as falling into a pit and dying.
...
Completing the main levels eventually unlocks access to a secret level containing additional content.
...
During the development of my first game, I did not yet understand the importance of maintaining a consistent pixel scale between different assets.

For this project, I improved my understanding of pixel-art production and worked toward keeping the pixel density and visual scale of the game's elements more consistent.
